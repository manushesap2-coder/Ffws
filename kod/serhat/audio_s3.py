...
B = TL.B
cuts = [(B(18), 1492), (B(25), 1490), (B(42), 1492), (B(47), 1490), (B(53), 1492), (B(61), 1492)]
...
pops = [TL.vo('çarşının')['T'] + 0.2, 30.65, 31.83, TL.vo('Geniş')['T'], TL.vo('yüksek')['T'], TL.vo('asma')['T'],
        TL.vo('farklı')['T'], TL.vo('ferah')['T'], 42.39, 43.0, 44.55, 45.61,
        TL.vo('güçlü')['T'], TL.vo('değerli')['T'], TL.vo('Serhat')['T'], TL.vo('İnci')['T']]
for tp in pops: sfx(3005, tp, 0.03, -19)
for t_line in (30.28, 31.22, 41.80, 42.72, 45.18): sfx(1491, t_line + 0.22, 0.30, -21)     # callout lines drawing
sfx(3005, 44.45, 0.03, -16)                                                             # pin lands
...
sf.write('/tmp/jobs/serhat/out/mix3_raw.wav', mix, SR, subtype='FLOAT')
# stems for QC
for nm, b in (('voice', mix_v), ('music', mix_m), ('sfx', mix_s)): sf.write(f'/tmp/jobs/serhat/out/stem3_{nm}.wav', b[:len(mix)], SR, subtype='FLOAT')
