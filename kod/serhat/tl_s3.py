...
VO_SPLIT, VO_PAUSE = 21.917, 0.40            # extra breath after 'Otopark avantajı,' so the parking callout can land
T_END = T_VO + 34.35 + VO_PAUSE + 2.45
...
# v3: customer markings (Yol / Adsız / işaret2) at the matching VO lines; no Pocket (P77) footage
...
SHOTS = [
    ...
    dict(n='PARK', t0=B(42), t1=B(47), kind='lin', src='D', s0=REF['park'] - (42.95 - B(42)), v=1.0, grade='ext',
         zoom=(1.08, 1.16), center=(620.0, 1235.0), tin=('zoom', 5), trk='trk_park'),
    dict(n='MEY', t0=B(47), t1=B(53), kind='lin', src='D', s0=REF['mey'] - (45.45 - B(47)), v=1.0, grade='ext',
         zoom=(1.30, 1.42), center=(778.0, 1000.0), tin=('whip', 5, (1, 0)), trk='trk_mey'),
    dict(n='WIDE', t0=B(53), t1=B(61), kind='lin', src='D', s0=95.0, v=6.4, grade='ext', tin=('zoom', 5)),
    dict(n='FINAL', t0=B(61), t1=T_END, kind='lin', src='D', s0=150.0, v=4.0, grade='ext', tin=('zoomout', 6)),
]
