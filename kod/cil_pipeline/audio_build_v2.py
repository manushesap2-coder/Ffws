...
EV = [  # (sfx id, time of its peak, gain dB)
    ...
    ('1493', B(7), -12), ('1490', B(9), -14), ('3115', B(11), -12), ('1491', B(11) + 0.02, -15), ('1489', B(14), -11), ('1493', B(17), -10),
...
subprocess.run(['ffmpeg', '-v', 'error', '-y', '-i', OUT + 'mix_pre.wav', '-af', af, '-ar', str(SR), '-c:a', 'pcm_s24le', OUT + 'mix_final_v2.wav'], check=True)
chk = subprocess.run(['ffmpeg', '-v', 'info', '-i', OUT + 'mix_final_v2.wav', '-af', 'ebur128=peak=true', '-f', 'null', '-'], capture_output=True, text=True).stderr
